...
class WebCam(object):
    ...
    def get_frame(self):
        ...
        _, test_image = cv2.threshold(frame1, 120, 255, cv2.THRESH_BINARY)
        ...
        cv2.putText(frame, prediction[0][0], (10, 120), cv2.FONT_HERSHEY_PLAIN, 5, (0,255,0), 1)
...
class PiCam(object):
    ...
    def __init__(self,usingPiCamera = True):
        self.picam = VideoStream(usePiCamera=True,resolution=(320,240)).start()
        self.pred = []
    ...
    def get_frame(self):
        ...
        cv2.rectangle(frame, (130,30), (200,150), (255,0,0) ,1)
        # Extracting the ROI
        roi = frame[30:150, 130:200]
        ...
        # Displaying the predictions
        cv2.putText(frame, prediction[0][0], (10, 120), cv2.FONT_HERSHEY_PLAIN, 3, (0,255,0), 1)
